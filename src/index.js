  ...
  try {
    ...
    fastify.io.on('connection', (socket) => {
      ...
      socket.on('clientGameJoin', async (e) => {
        ...
        fastify.io.in('lobby').emit('clientGameJoin', {game: game._id, socket: socket.id, percentToFull: game.players.length / config.numPlayersToStart, numCurrentPlayers: game.players.length, numPlayersToFull: config.numPlayersToStart });
